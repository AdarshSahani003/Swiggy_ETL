...
from (
    ...
    from @stage_sch.csv_stg/initial/order_items/order-Item-initial.csv t
)
...
-- part-2
list @stage_sch.csv_stg/delta/order_items/;
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @stage_sch.csv_stg/delta/order_items/day-02-order-item.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;