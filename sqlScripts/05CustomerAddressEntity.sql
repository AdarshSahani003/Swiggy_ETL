...
create or replace table stage_sch.customer_address (
...
on table stage_sch.customer_address
append_only = true
...
copy into stage_sch.customer_address (addressid, customerid, flatno, houseno, floor, building, 
...
from (
    ...
    from @stage_sch.csv_stg/initial/customer_address/customer_address_book_initial.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;

list @stage_sch.csv_stg/initial/customer_address/customer_address_book_initial.csv;
